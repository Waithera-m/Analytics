...
@Component({
  selector: 'app-onetwenty-revenue',
  templateUrl: './onetwenty-revenue.component.html',
  styleUrls: ['./onetwenty-revenue.component.css']
})
export class OnetwentyRevenueComponent implements OnInit {
